...
That's it! That's all I have to say. The younger more naive python programmer would have thought, ‘Why would it matter anyway?’. But I’m lot wiser now, since I have witnessed some really ugly stack traces in Sentry. Stack traces can be helpful in debugging,  but they also can be revealing of how horrible results can some of the seeming harmless bugs can lead to.
